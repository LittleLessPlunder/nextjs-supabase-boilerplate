      ...
      <div className="grid md:grid-cols-2 gap-16 md:gap-24">
        ...
        <div className="book-col">
          ...
          <p className="font-sans text-white/60 text-[15px] leading-relaxed mb-10 max-w-xs">
            Drop-in and package rates available. Beginners always welcome —
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-ytw-terracotta text-white font-label text-[11px] tracking-[0.22em] uppercase px-8 py-4 hover:bg-ytw-cognac transition-colors duration-300"
          >
            Book via Instagram →
          </a>
          ...
          <div className="mt-12 space-y-3">
            {[
              ...
              <div key={time} className="flex items-center gap-4 border-b border-white/[0.08] pb-3">
